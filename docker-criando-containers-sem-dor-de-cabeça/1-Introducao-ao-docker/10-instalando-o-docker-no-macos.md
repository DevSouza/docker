# 10 Instalando o Docker no macOS

Para instalar o [Docker no MacOS](https://store.docker.com/editions/community/docker-ce-desktop-mac), utilizamos o Docker for Mac, no qual podemos baixar o instalador clicando [aqui](https://download.docker.com/mac/stable/Docker.dmg).
...
![Docker no macOS](./imagens/docker-macos.png)
