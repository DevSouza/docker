...
Primeiramente, devemos falar sobre a **Docker, Inc.**, que no início era chamada de **dotCloud**. A **dotCloud** era uma empresa de **PaaS** (**P**latform **a**s a **S**ervice), sendo responsável pela hospedagem da nossa aplicação, levantando o servidor, configurando-o, liberando portas, etc, fazendo tudo o que é necessário para subir a nossa aplicação. Outros exemplos de empresas de **PaaS** são o **Heroku**, **Microsoft Azure** e **Google Cloud Platform**.
