# 08 Instalando o Docker no Windows
...
![Verificando se a virtualização está habilitada](./imagens/virtualizacao-habilitada.png)
...
![Docker no Windows](./imagens/docker-windows.png)
