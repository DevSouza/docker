# 02 Entendendo a aplicação

> O código do projeto pode ser baixado [aqui](./source/alura-docker-cap06.zip).
...
**Isso já está tudo pronto, basta baixarmos o código da imagem e da aplicação [aqui](./source/alura-docker-cap06.zip)**.
