# 07 Subindo os serviços

> Se você utiliza Linux, provavelmente não conseguirá utilizar o **Docker Compose**, pois o mesmo não é instalado na instalação padrão. Para instalá-lo, primeiramente faça [este exercício](./06-instalando-o-docker-compose-no-linux.md) e prossiga com o treinamento.
