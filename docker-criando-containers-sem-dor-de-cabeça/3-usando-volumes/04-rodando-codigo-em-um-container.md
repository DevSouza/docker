...
Para isso, vamos usar um exemplo escrito **Node.js**, que pode ser baixado [aqui](./arquivos/volume-exemplo.zip). Até podemos executar esse código na nossa máquina, mas temos que instalar o Node na versão certa em que o desenvolvedor implementou o código.
